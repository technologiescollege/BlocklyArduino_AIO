...
class PymataCore:
    ...
    def _discover_port(self):
        ...
        #
        # if len(ard_ports) > 1:
        #     print('Multiple Arduino device detected on com ports:')
        #     for port in ard_ports:
        #         print(port)
        #     print('Use the com_port parameter to select the com port you wish to use')
        #     sys.exit(0)
        # # found just one - use that port
        # port = ard_ports[0]
        # return port
